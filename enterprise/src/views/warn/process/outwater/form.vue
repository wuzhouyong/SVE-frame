<template>
  ...
  >
    ...
    <div class="alarmCompany" style="height: 100%">
      <ul v-if="warnProList.length > 0" style="padding: 0">
        <li
          v-for="i in warnProList"
          :key="i.key"
    ...
    <upload :warnId="form.warnId" ref_type="psh_warn_file"></upload>
  </form-dialog>
</template>
<script>

<template>
    <div class="base-list">
        ...
        <el-table
            ...
            border
        >
            <el-table-column prop="levelName" label="预警级别" width="180"></el-table-column>
            <el-table-column prop="procName" label="处理状态" width="180"></el-table-column>
            <el-table-column prop="typeName" label="预警类型" width="180"></el-table-column>
            <el-table-column prop="startDate" label="预警时间" width="180"></el-table-column>

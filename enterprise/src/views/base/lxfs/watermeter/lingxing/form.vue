      ...
      <el-form :model="formData" :rules="rules" size="medium" label-width="140px" ref="waterForm">
        ...
        <el-col :lg="12" :md="12" :sm="24" class="elBox-style">
          <el-card class="box-card">
            <el-form-item label="因子类型:" label-width="100px">自来水工业用水流量(w100)</el-form-item>
        ...
        <el-col :lg="12" :md="12" :sm="24" class="elBox-style">
          <el-card class="box-card">
            <el-form-item label="因子类型:" label-width="100px">自来水工业用水瞬时流量(w101)</el-form-item>

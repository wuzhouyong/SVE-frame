<template>
  <div class="base-list">
    ...
    <!-- 查看流程图-->
    <flow-real v-if="flowRealShow" type="qixiu" :visible.sync="flowRealShow"></flow-real>
  </div>
</template>
<script>
  import {list, remove} from "@/api/outlet";
  import OutletForm from "./form";
  import FlowReal from "@/views/components/flowReal/index";

  export default {
    components: {OutletForm,FlowReal},
    data() {
      return {
        loading: true,
        title: undefined,

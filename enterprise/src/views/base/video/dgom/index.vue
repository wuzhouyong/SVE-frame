<template>
  <div class="base-list">
    ...
    >
      ...
      <el-table-column prop="fullName" label="污染源" width="240"></el-table-column>
      <el-table-column prop="videoDesc" label="视频名称" width="220"></el-table-column>
      <el-table-column label="视频类型" width="180">
        <template slot-scope="scope">
          {{ videoTypeList[scope.row.videoType] }}
        </template>
      </el-table-column>
      <el-table-column prop="videoAddress" label="视频地址" min-width="220"></el-table-column>

    ...
    <div class="history_context" v-else>
      ...
      <div v-else>
        <div class="select-type">
          <el-button :type="activeType==='all'?'primary':''" icon="el-icon-document" :autofocus="true" size="mini"
                     @click="selectType('all')">全部
          </el-button>
          <el-button :type="activeType==='enterprise'?'primary':''" icon="el-icon-edit-outline" size="mini"
...
<script>
import {warnDetails, warnHistory} from "@/api/warn";

  ...
  <div class="task-warn-wk">
    ...
    <el-form :model="queryForm" class="task-warn-form" ref="queryForm" label-width="80px" :inline="true">
      ...
      <el-form-item label="异常类型" prop="warnType" v-show="isChangeSys">
        <el-select v-model="queryForm.warnType" style="width:164px" size="mini">
          <el-option
            :label="i.dictLabel"
            :value="i.dictValue"
      ...
      <el-form-item label="异常级别" prop="warnLevel">
        <el-select v-model="queryForm.warnLevel" size="mini" style="width:164px" :disabled="activeName==='pending'">
          <el-option
            :label="i.dictLabel"
            :value="i.dictValue"
    ...
    >
      ...
      <el-table-column prop="procStatusName" label="处理状态" width="80">
...
<!--        </template>-->
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" icon="el-icon-thumb" @click="submitForm" size="mini">提 交</el-button>
      </span>
    </el-dialog>
    <!--    查看详情-->
    <el-dialog

...
import com.ruoyi.project.jiayou.mapper.DataSearchMapper;
...
public class DataSearchImpl implements DataSearchService {
    ...
    public DataSearchResult getReal(DataSearchParam entity) {
        ...
        List<DataSearchColEntity> cols = dataSearchMapper.getDataCol(entity);
    ...
    public ResultEntity getHourSummary(DataSearchParam entity) {
        ...
        cols.add(0, new DataSearchColEntity("时间", "date"));
    ...
    @Override
    public List<DataSearchColEntity> getDataCol(DataSearchParam entity) {
        return dataSearchMapper.getDataCol(entity);
    }
    ...
    @Override // 加油近30天传输率曲线图数据-Minute
    ...
    @Override // 获取加油近30天传输率图总数据,分钟,小时,天 数据

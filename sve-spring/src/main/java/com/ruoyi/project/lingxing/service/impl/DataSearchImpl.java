...
import com.ruoyi.project.lingxing.mapper.DataSearchMapper;
...
public class DataSearchImpl implements DataSearchService {
    ...
    @Override  // 零星废水近30天传输率曲线图数据-Hour
    ...
    @Override  // 零星废水近30天传输率曲线图数据-Minute
    ...
    @Override  // 获取零星废水近30天传输率图总数据,分钟,小时,天 数据

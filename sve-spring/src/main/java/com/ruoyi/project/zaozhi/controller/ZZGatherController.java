 ...
 */
@RestController
@RequestMapping("/zaozhi/statistical")
public class ZZGatherController extends BaseController {

    @Autowired
    private ZZGatherService gatherService;

    @PostMapping("/enterprise") //企业异常汇总
    public ResultEntity enterpriseList(@RequestBody ZZGatherEntity entity) {
        return ResultEntity.success(gatherService.getEnterpriseList(entity));
    }

    @PostMapping("/export_enterprise")
    public AjaxResult AbnormalEnterprise(@RequestBody ZZGatherEntity entity) {
        List<ZZExportGatherEntity> data = gatherService.getEnterpriseList(entity);
    ...
    public ResultEntity townAbnormalList(@RequestBody ZZGatherEntity entity) {
        return ResultEntity.success(gatherService.getTownAbnormalList(entity));
    }

    @PostMapping("/export_town")
    public AjaxResult townAbnormal(@RequestBody ZZGatherEntity entity) {
        List<ZZExportGatherEntity> data = gatherService.getTownAbnormalList(entity);
        DocumentUtil doc = new DocumentUtil(data);
    ...
    public TableDataInfo getSourceAbnor(@RequestBody ZZSourceAbnorEntity entity) {
        startPage();
        List<ZZSourceAbnorEntity> list = gatherService.getSourceAbnor(entity);

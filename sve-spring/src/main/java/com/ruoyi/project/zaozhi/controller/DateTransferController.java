...
@RestController("zz1_zaozhi")
@RequestMapping("/zaozhi/transfer")
public class DateTransferController extends BaseController {
    ...
    @GetMapping("/real")  //   /zaozhi/transfer/real
    ...
    // 造纸业近30天传输率曲线图数据-Day
    @GetMapping("/day")  //   /zaozhi/transfer/day
    ...
    @GetMapping("/hour")  //   /zaozhi/transfer/hour
    ...
    @GetMapping("/minute")  //   /zaozhi/transfer/minute
    ...
    @GetMapping("/chart")  //   /zaozhi/transfer/chart
    ...
    // 获取企业联网状态总条数
    @GetMapping("/procstate")  //   /zaozhi/transfer/procstate

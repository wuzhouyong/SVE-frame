...
@RestController("gc1_guocheng")
@RequestMapping("/guocheng/transfer")
public class DataTransferController extends BaseController {
    ...
    // 过程近30天传输率曲线图数据-Real
    @GetMapping("/real")  //   /guocheng/transfer/real
    ...
    // 过程近30天传输率曲线图数据-Day
    @GetMapping("/day")  //   /guocheng/transfer/day
    ...
    // 过程近30天传输率曲线图数据-Hour
    @GetMapping("/hour")  //   /guocheng/transfer/hour
    ...
    // 过程近30天传输率曲线图数据-Minute
    @GetMapping("/minute")  //   /guocheng/transfer/minute
    ...
    // 获取过程监控近30天传输率图总数据,分钟,小时,天 数据
    @GetMapping("/chart")  //   /guocheng/transfer/chart
    ...
    // 获取企业联网状态总条数
    @GetMapping("/procstate")  //   /guocheng/transfer/procstate

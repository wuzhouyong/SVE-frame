...
import com.ruoyi.project.qixiu.mapper.DataSearchMapper;
...
public class DataSearchImpl implements DataSearchService {
    ...
    @Override  // 汽修近30天传输率曲线图数据-Minute
    ...
    @Override  // 获取汽修近30天传输率图总数据,分钟,小时,天 数据

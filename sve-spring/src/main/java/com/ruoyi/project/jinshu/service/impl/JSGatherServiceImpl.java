...
import com.ruoyi.project.jinshu.mapper.JSGatherMapper;
...
public class JSGatherServiceImpl implements JSGatherService {

    @Autowired
    private JSGatherMapper gatherMapper;

    @Override
    public List<JSExportGatherEntity> getEnterpriseList(JSGatherEntity entity) {
        return gatherMapper.getEnterpriseList(entity);
    }

    @Override
    public List<JSExportGatherEntity> getTownAbnormalList(JSGatherEntity entity) {
    ...
    @Override
    public List<JSSourceAbnorEntity> getSourceAbnor(JSSourceAbnorEntity entity) {

...
import com.ruoyi.project.jinshu.mapper.DataSearchMapper;
...
public class DataSearchImpl implements DataSearchService {
    ...
    @Override  // 金属近30天传输率曲线图数据-Minute
    ...
    @Override  // 获取金属近30天传输率图总数据,分钟,小时,天 数据

...
import com.ruoyi.project.jinshu.service.JSGatherService;
 ...
 */
@RestController
@RequestMapping("/jinshu/statistical")
public class JSGatherController extends BaseController {

    @Autowired
    private JSGatherService gatherService;

    @PostMapping("/enterprise") //企业异常汇总
    public ResultEntity enterpriseList(@RequestBody JSGatherEntity entity) {
        return ResultEntity.success(gatherService.getEnterpriseList(entity));
    }

    @PostMapping("/export_enterprise")
    public AjaxResult AbnormalEnterprise(@RequestBody JSGatherEntity entity) {
        List<JSExportGatherEntity> data = gatherService.getEnterpriseList(entity);
    ...
    public ResultEntity townAbnormalList(@RequestBody JSGatherEntity entity) {
        return ResultEntity.success(gatherService.getTownAbnormalList(entity));
    }

    @PostMapping("/export_town")
    public AjaxResult townAbnormal(@RequestBody JSGatherEntity entity) {
        List<JSExportGatherEntity> data = gatherService.getTownAbnormalList(entity);
        DocumentUtil doc = new DocumentUtil(data);
    ...
    public TableDataInfo getSourceAbnor(@RequestBody JSSourceAbnorEntity entity) {
        startPage();
        List<JSSourceAbnorEntity> list = gatherService.getSourceAbnor(entity);

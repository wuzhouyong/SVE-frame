...
import com.ruoyi.project.voc.mapper.DataSearchMapper;
...
public class DataSearchImpl implements DataSearchService {
    ...
    public DataSearchResult getReal(DataSearchParam entity) {
        ...
        Date endTime = Date.from(startTime.toInstant().plusSeconds(60 * 60));
    ...
    public DataSearchResult getMinute(DataSearchParam entity) {
        ...
        Date endTime = Date.from(startTime.toInstant().plusSeconds(60 * 60 * 24));
    ...
    public ResultEntity getHourSummary(DataSearchParam entity) {
        ...
        List<DataSearchColEntity> cols = dataSearchMapper.getDataSummaryCol(entity);
        cols.add(0, new DataSearchColEntity("时间", "date", "200"));
    ...
    @Override  // VOC近30天传输率曲线图数据-Minute
    ...
    @Override  // 获取VOC近30天传输率图总数据,分钟,小时,天 数据

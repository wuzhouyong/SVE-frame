...
import com.ruoyi.project.voc.mapper.VocGatherMapper;
...
public class VocGatherServiceImpl implements VocGatherService {

    @Autowired
    private VocGatherMapper gatherMapper;

    @Override
    public List<VocExportGatherEntity> getEnterpriseList(VocGatherEntity entity) {
        return gatherMapper.getEnterpriseList(entity);
    }

    @Override
    public List<VocExportGatherEntity> getTownAbnormalList(VocGatherEntity entity) {
    ...
    @Override
    public List<VOCSourceAbnorEntity> getSourceAbnor(VOCSourceAbnorEntity entity) {
    ...
    @Override
    public List<Map> getTownWarnAmt(Map<String, String> param) {
        return HashMapUtils.toLower(gatherMapper.getTownWarnAmt(param));
    }

    @Override
    public List<Map> getTownWarnEnterprise(Map<String, String> param) {
        return HashMapUtils.toLower(gatherMapper.getTownWarnEnterprise(param));
    }

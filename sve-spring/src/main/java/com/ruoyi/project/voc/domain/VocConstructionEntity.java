...
public class VocConstructionEntity implements Serializable {
    ...
    public String toString() {
        return "VocConstructionEntity{" +
                "sourceId='" + sourceId + '\'' +
                ", constructionStatus=" + constructionStatus +
                ", constructionUnit='" + constructionUnit + '\'' +
                ", constructionPerson='" + constructionPerson + '\'' +
                ", constructionPhone='" + constructionPhone + '\'' +
                ", tagHeadId='" + tagHeadId + '\'' +
                ", completeDate='" + completeDate + '\'' +
                ", completeMemo='" + completeMemo + '\'' +
                ", acceptanceDate='" + acceptanceDate + '\'' +
                ", acceptanceMemo='" + acceptanceMemo + '\'' +
                ", isDeleted=" + isDeleted +
                ", createdBy='" + createdBy + '\'' +
                ", updatedBy='" + updatedBy + '\'' +

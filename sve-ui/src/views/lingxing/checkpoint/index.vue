<template>
  <div class="task-wk">
    ...
    <!--          size="mini"-->
    <!--          @click="handleAdd"-->
    <!--          v-hasPermi="['lingxing:checkpoint:add']"-->
    <!--        >新增</el-button>-->
    <!--      </el-col>-->
    <!--      <el-col :span="1.5">-->
    <!--        <el-button-->
    ...
    <!--          :disabled="!single"-->
    <!--          @click="handleUpdate"-->
    <!--          v-hasPermi="['lingxing:checkpoint:edit']"-->
    <!--        >修改</el-button>-->
    <!--      </el-col>-->
    <!--      <el-col :span="1.5">-->
    <!--        <el-button-->
    ...
    <!--          :disabled="multiple"-->
    <!--          @click="handleDelete"-->
    <!--          v-hasPermi="['lingxing:checkpoint:del']"-->
    <!--        >删除</el-button>-->
    <!--      </el-col>-->
    <!--    </el-row>-->
    <!-- 表格 -->
...
<script>
import { checkpointList, checkpointDel } from "@/api/lingxing";

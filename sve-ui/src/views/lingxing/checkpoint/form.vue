<template>
  ...
  >
    <el-form-item label="污染源" prop="sourceId">
      <SelectSource v-model="form.sourceId" :data="sourceList" placeholder="请输入污染源" isPlatName="lingxing"></SelectSource>
    </el-form-item>
...
<script>
import { sourceList, checkpointAdd, checkpointEdit } from "@/api/lingxing";

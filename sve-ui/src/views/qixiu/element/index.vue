<template>
  <div class="task-wk">
    ...
    >
      ...
      <el-table-column prop="sourceName" label="污染源" min-width="220" show-overflow-tooltip></el-table-column>
      <el-table-column prop="cpName" label="数采名称" width="160" show-overflow-tooltip></el-table-column>
      <el-table-column prop="outletName" label="排放口" width="160" show-overflow-tooltip></el-table-column>
      <el-table-column prop="eleDesc" label="因子名称" width="160" show-overflow-tooltip></el-table-column>
      <el-table-column prop="eleTypeDesc" label="因子类型"></el-table-column>
      <el-table-column prop="eleCode" label="因子编码" width="90"></el-table-column>
      <el-table-column prop="installLocation" label="安装位置" width="220" show-overflow-tooltip></el-table-column>
      <el-table-column prop="checkDate" label="检测时间">
        <template slot-scope="scope">{{ scope.row.checkDate ? scope.row.checkDate : "-" }}</template>
      </el-table-column>
      <el-table-column prop="isOnline" align="center" label="是否在线" width="90">
...
<script>
import {elementList, elementDel} from "@/api/qixiu";

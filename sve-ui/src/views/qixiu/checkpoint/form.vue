<template>
  ...
  >
    <el-form-item label="污染源" prop="sourceId">
      <SelectSource v-model="form.sourceId" :data="sourceList" placeholder="请输入污染源" isPlatName="qixiu"></SelectSource>
    </el-form-item>
...
<script>
import { sourceList, checkpointAdd, checkpointEdit } from "@/api/qixiu";

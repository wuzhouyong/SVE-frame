<template>
  <div class="task-wk">
    <!-- 搜索表单 -->
    <el-form :model="queryForm" ref="queryForm" :inline="true" class="jinshu-serchForm">
...
<!--          size="mini"-->
<!--          @click="handleAdd"-->
<!--          v-hasPermi="['jinshu:checkpoint:add']"-->
<!--        >新增</el-button>-->
<!--      </el-col>-->
<!--      <el-col :span="1.5">-->
<!--        <el-button-->
...
<!--          :disabled="!single"-->
<!--          @click="handleUpdate"-->
<!--          v-hasPermi="['jinshu:checkpoint:edit']"-->
<!--        >修改</el-button>-->
<!--      </el-col>-->
<!--      <el-col :span="1.5">-->
<!--        <el-button-->
...
<!--          :disabled="multiple"-->
<!--          @click="handleDelete"-->
<!--          v-hasPermi="['jinshu:checkpoint:del']"-->
<!--        >删除</el-button>-->
<!--      </el-col>-->
<!--    </el-row>-->
    <!-- 表格 -->
...
<script>
import { checkpointList, checkpointDel } from "@/api/jinshu";

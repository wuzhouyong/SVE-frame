<template>
  <div class="task-wk">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="!single"
          @click="handleUpdate"
          v-hasPermi="['jiayou:element:edit']"
        >修改
        </el-button>
      </el-col>
      <el-col :span="1.5">
    ...
    >
      ...
      <el-table-column prop="eleDesc" label="因子名称" width="120"></el-table-column>
      <el-table-column prop="eleTypeDesc" label="因子类型" width="120"></el-table-column>
      <el-table-column prop="eleCode" label="因子编码" width="120"></el-table-column>
      ...
      <el-table-column prop="isOnline" align="center" label="是否在线" width="120">
...
<script>
import { elementList, elementDel } from "@/api/jiayou";

...
<!--          size="mini"-->
<!--          @click="handleAdd"-->
<!--          v-hasPermi="['guocheng:checkpoint:add']"-->
<!--        >新增</el-button>-->
<!--      </el-col>-->
<!--      <el-col :span="1.5">-->
<!--        <el-button-->
...
<!--          :disabled="!single"-->
<!--          @click="handleUpdate"-->
<!--          v-hasPermi="['guocheng:checkpoint:edit']"-->
<!--        >修改</el-button>-->
<!--      </el-col>-->
<!--      <el-col :span="1.5">-->
<!--        <el-button-->
...
<!--          :disabled="multiple"-->
<!--          @click="handleDelete"-->
<!--          v-hasPermi="['guocheng:checkpoint:del']"-->
<!--        >删除</el-button>-->
<!--      </el-col>-->
<!--    </el-row>-->
    <!-- 表格 -->
...
<script>
import { checkpointList, checkpointDel } from "@/api/guocheng";

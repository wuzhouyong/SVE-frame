<template>
  <div class="task-wk">
    ...
    <el-table
      ...
      border
    >
      <el-table-column prop="fullName" label="污染源" width="200" show-overflow-tooltip></el-table-column>
...
import {abnormalEnterprise, exportEnterprise} from "@/api/guocheng";

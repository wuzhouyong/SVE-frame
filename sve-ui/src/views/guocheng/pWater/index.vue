<template>
  ...
  <div class="lx-wk">
    <div class="lx-left">
      <n-sourceLeft @selectSource="selectSource" tagHeadId="1002"></n-sourceLeft>
    </div>
...
<script>
import {gcEterpriseWater} from '@/api/guocheng'

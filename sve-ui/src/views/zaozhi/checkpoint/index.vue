<template>
  <div class="task-wk">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['zaozhi:checkpoint:add']"
        >新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="!single"
          @click="handleUpdate"
          v-hasPermi="['zaozhi:checkpoint:edit']"
        >修改
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['zaozhi:checkpoint:del']"
        >删除
        </el-button>
      </el-col>
    </el-row>
    ...
    >
      ...
      <el-table-column label="是否中环认证" width="180">
        <template slot-scope="scope">{{ scope.row.isEnvcert === "true" ? "是" : "否" }}</template>
      </el-table-column>
...
<script>
import {checkpointList, checkpointDel} from "@/api/zaozhi";

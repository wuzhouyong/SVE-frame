      ...
      <transition name="el-fade-in-linear">
        ...
        >
          <el-table-column
            ...
            :key="i.dataIndex"
            :width="i.dataIndex==='date'?'140':null"
...
import {searchReal} from "@/api/home";
...
export default {
  ...
  methods: {
    ...
    getList (v = {}) {
      this.loading = true;
      searchReal(v, this.platFormPath).then((res) => {
        if (res.code === 200) {

<template>
  <div class="task-wk">
    ...
    >
      ...
      <el-table-column prop="cpName" label="数采名称" show-overflow-tooltip></el-table-column>
      <!-- <el-table-column prop="outletName" label="排放口" show-overflow-tooltip></el-table-column> -->
...
<script>
import { elementList, elementDel } from "@/api/voc";

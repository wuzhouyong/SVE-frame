...
<script>
import {emissionTownWaste, emissionMonthWaste, emissionTownMonth} from "@/api/currency";
...
export default {
  ...
  methods: {
    ...
    getTownWaste(v) {
      emissionTownWaste(this.activeName, v).then(res => {
        if (res.code === 200) {
    ...
    getMonthWaste(v) {
      emissionMonthWaste(this.activeName, v).then(res => {
        if (res.code === 200) {
    ...
    getTownMonth(v) {
      emissionTownMonth(this.activeName, v).then(res => {
        if (res.code === 200) {

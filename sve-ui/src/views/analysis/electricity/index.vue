...
<script>
import {stTownelEctric, stMonthElectric, stTownMonthElectric} from "@/api/currency";
...
export default {
  ...
  methods: {
    ...
    getTownWaste(v) {
      stTownelEctric(this.activeName, v).then(res => {
        if (res.code === 200) {
    ...
    getMonthWaste(v) {
      stMonthElectric(this.activeName, v).then(res => {
        if (res.code === 200) {
    ...
    getTownMonth(v) {
      stTownMonthElectric(this.activeName, v).then(res => {
        if (res.code === 200) {

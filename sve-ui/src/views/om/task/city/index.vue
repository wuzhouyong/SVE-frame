<template>
  <div class="task-wk">
    ...
    <el-dialog
      ...
      width="700px">
      <n-handle :hData="selectRows" :isAgree="isAgree" v-if="handleVisible"></n-handle>
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" size="mini">退回任务</el-button>
  ...
  computed: {
    multiple () {
      if (this.selectRows.length === 1) {
        return new Set([5]).has(this.selectRows[0].taskStatus);
      }
    },
  },
  created () {

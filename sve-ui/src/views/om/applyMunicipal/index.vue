<template>
  <div class="task-wk">
    ...
    <el-table
      ...
      >
        <template slot-scope="scope">
          <el-link type="primary" :underline="false" style="font-size:12px;" @click="applyMsg(scope.row)">确认</el-link>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页 -->
    ...
    <el-dialog
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="success" @click="subMit(4)">同 意</el-button>
        <el-button type="danger" @click="subMit(5)">退 回</el-button>
      </div>
    </el-dialog>
  </div>
</template>

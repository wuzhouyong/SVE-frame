<template>
  <div class="apply-lw">
    ...
    <el-form label-width="140px" style="height:160px">
      ...
      <el-col :lg="24" :md="24" :sm="24">
        <el-form-item label="处理时间">
          <el-input v-model="detailsData.approvedDate" size="mini" :rows="4" readonly></el-input>
        </el-form-item>
      </el-col>
      <el-col :lg="24" :md="24" :sm="24">
        <el-form-item label="分局批复意见">
          <el-input v-model="detailsData.approvalDesc" size="mini" type="textarea" :rows="4" readonly></el-input>
        </el-form-item>
      </el-col>
    </el-form>
    <el-divider content-position="left">
    ...
    <el-form :model="detailsData" label-width="140px" style="height:160px">
      <el-col :lg="24" :md="24" :sm="24">
...
<script>
import {dgomannexList} from "@/api/om";

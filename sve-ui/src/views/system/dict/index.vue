<template>
  <div class="app-container">
      ...
      <el-table-column label="字典类型" align="center" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          ...
          <el-link
            ...
            @click="routeLink(scope.row.dictId)"
          >{{ scope.row.dictType }}
          </el-link>
        </template>
      </el-table-column>
    ...
    <el-dialog title="字典数据" :visible.sync="openVisible" width="1200px" custom-class="show-dict-details" v-dialogDrag>
      <n-data :dictId="dictId" v-if="openVisible"></n-data>
    </el-dialog>
  </div>
</template>
